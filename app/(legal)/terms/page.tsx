    ...
    <main className="min-h-screen py-20 px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="text-gray-800 space-y-8">
          ...
          >
            <h2 id="section-1-title" className="text-2xl font-bold text-purple-400 mb-6 flex items-center gap-3">
              <span className="w-8 h-8 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-white font-mono text-sm" aria-hidden="true">1</span>
              Website Use
            </h2>
            ...
            <ul className="list-disc ml-6 mb-4 space-y-1" role="list">
          ...
          >
            <h2 id="section-2-title" className="text-2xl font-bold text-cyan-400 mb-4 flex items-center gap-3">
              <span className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center text-white font-mono text-sm" aria-hidden="true">2</span>
          ...
          >
            <h2 id="section-3-title" className="text-2xl font-bold text-cyan-400 mb-4 flex items-center gap-3">
              <span className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center text-white font-mono text-sm" aria-hidden="true">3</span>
              Privacy
            </h2>
            <p>Your privacy is important to us. Please review our <a href="/privacy" className="text-cyan-400 underline hover:text-cyan-300 transition-colors" aria-label="Read our Privacy Policy">Privacy Policy</a> to understand how your information is collected, used, and protected while using this Website.</p>
          </motion.section>

          {/* Remaining sections */}
          <section aria-labelledby="section-4-title" className="space-y-6">
            <h2 id="section-4-title" className="text-2xl font-bold text-purple-400 mb-4 flex items-center gap-3">
          ...
          <section aria-labelledby="section-5-title">
            <h2 id="section-5-title" className="text-xl font-semibold mt-8 text-blue-400">5. Limitation of Liability</h2>
          ...
          <section aria-labelledby="section-6-title">
            <h2 id="section-6-title" className="text-xl font-semibold mt-8 text-cyan-400">6. Third-Party Links</h2>
          ...
          <section aria-labelledby="section-7-title">
            <h2 id="section-7-title" className="text-xl font-semibold mt-8 text-purple-400">7. User Contributions</h2>
          ...
          <section aria-labelledby="section-8-title">
            <h2 id="section-8-title" className="text-xl font-semibold mt-8 text-cyan-400">8. Modifications to the Website</h2>
            <p>Elio Gerges reserves the right to modify, suspend, or discontinue any part of the Website at any time without notice.</p>
          </section>

          <section aria-labelledby="section-9-title">
            <h2 id="section-9-title" className="text-xl font-semibold mt-8 text-blue-400">9. Termination</h2>
          ...
          <section aria-labelledby="section-10-title">
            <h2 id="section-10-title" className="text-xl font-semibold mt-8 text-purple-400">10. Governing Law</h2>
          ...
          <section aria-labelledby="section-11-title">
            <h2 id="section-11-title" className="text-xl font-semibold mt-8 text-cyan-400">11. Indemnification</h2>
          ...
          <section aria-labelledby="section-13-title">
            <h2 id="section-13-title" className="text-xl font-semibold mt-8 text-purple-400">13. Contact Information</h2>
            <p className="mb-4">
              For questions or concerns about these Terms and Conditions, please contact:
              <br />
              <strong>Email:</strong> <a href="mailto:legal@eliogerges.com" className="text-blue-600 underline hover:text-blue-500 transition-colors" aria-label="Email legal team">legal@eliogerges.com</a>
              <br />
