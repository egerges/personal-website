...
export const LargeWobbleCard: React.FC<{
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between h-full min-h-[300px] md:min-h-[250px] gap-6">
      ...
      <div className="flex-shrink-0 w-full md:w-auto">
        <Image
          ...
          width={400}
          height={250}
          className="object-cover rounded-lg shadow-lg w-full md:w-[400px] h-[200px] md:h-[250px]"
        />
      </div>
    </div>
  );
